        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6 relative z-10">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-3.5 justify-center">
            <button
              ...
              className="px-6 py-3.5 rounded-lg bg-gradient-to-r from-[#c89b3c] to-[#a87e28] hover:from-[#d9ab4b] hover:to-[#b88c32] text-black font-semibold text-xs uppercase tracking-wider transition shadow-xl shadow-[#c89b3c]/20 flex items-center justify-center gap-2 min-h-[44px]"
            >
            ...
            <button
              ...
              className="px-6 py-3.5 rounded-lg bg-[#1a1d26] hover:bg-[#252936] text-stone-200 hover:text-white border border-[#34384a] font-semibold text-xs uppercase tracking-wider transition flex items-center justify-center gap-2 min-h-[44px]"
            >
            ...
            <button
              ...
              className="px-6 py-3.5 rounded-lg bg-[#14161d] hover:bg-[#1f222d] text-[#c89b3c] border border-amber-900/50 font-semibold text-xs uppercase tracking-wider transition flex items-center justify-center gap-2 min-h-[44px]"
            >
