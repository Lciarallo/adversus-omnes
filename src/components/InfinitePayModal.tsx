...
export const InfinitePayModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl bg-[#15171e] border border-[#2d313f] rounded-xl shadow-2xl overflow-hidden z-10">
        {/* Modal Header */}
        <div className="bg-[#101217] px-6 py-4 border-b border-[#252834] flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-cinzel font-bold text-white tracking-wide">
          ...
          <button
            onClick={handleClose}
            className="p-1 rounded-lg text-stone-400 hover:text-white hover:bg-[#252834] transition"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="p-6">
          {isSuccess ? (
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-2 justify-center">
                {checkoutType === 'subscription' ? (
                  <button
                    ...
                    className="px-5 py-2.5 rounded bg-[#c89b3c] text-black font-semibold text-xs hover:bg-[#dbaa42] transition"
                  >
                ...
                <button
                  onClick={handleClose}
                  className="px-4 py-2.5 rounded bg-[#252834] text-stone-300 text-xs hover:bg-[#2f3342] transition"
                >
                  Voltar ao Início
                </button>
              </div>
            ...
            <div className="space-y-6">
              {/* Order / Subscription Summary Banner */}
              <div className="p-3.5 rounded-lg bg-[#191c24] border border-[#2b2f3d] flex items-center justify-between">
                <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs">
                    <input
                      ...
                      className="bg-[#111318] border border-[#313544] rounded p-2 text-white"
                    />
                    <input
                      type="text"
                      ...
                      className="col-span-1 sm:col-span-2 bg-[#111318] border border-[#313544] rounded p-2 text-white"
                    />
                    <input
                      type="text"
                      placeholder="Número"
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="text-[10px] bg-emerald-900/60 text-emerald-300 px-1 rounded">
                      Rápido
                    </span>
                  </button>
              ...
              {/* Method Detail */}
              {paymentMethod === 'pix' ? (
                <div className="p-4 rounded-lg bg-[#111318] border border-[#2b2f3d] space-y-3">
                  <div className="flex flex-col sm:flex-row items-center gap-4">
                    ...
                    <div className="w-28 h-28 bg-white p-1.5 rounded-lg shrink-0 flex items-center justify-center shadow-md">
                      <div className="w-full h-full border-2 border-black grid grid-cols-4 gap-0.5 p-1">
                    ...
                    <div className="space-y-2 text-center sm:text-left flex-1 min-w-0">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#242734] hover:bg-[#303444] border border-[#3d4254] text-xs font-medium text-stone-200 transition"
                      >
                        {pixCopied ? (
                          <>
                          ...
                          <>
                            <Copy size={14} className="text-[#c89b3c]" />
                  ...
                  <div className="text-[10px] text-stone-500 font-mono truncate bg-[#0d0e12] p-2 rounded border border-[#222530]">
                    {mockPixPayload}
                  </div>
                </div>
              ) : (
                <div className="p-4 rounded-lg bg-[#111318] border border-[#2b2f3d] space-y-3">
                  <div className="space-y-2">
                    <label className="text-xs text-stone-400 block">Número do Cartão</label>
                    <input
                      type="text"
                      value={cardData.number}
                      onChange={e => setCardData({ ...cardData, number: e.target.value })}
                      className="w-full bg-[#181a22] border border-[#313544] rounded p-2 text-xs text-white font-mono"
                    />
                  </div>

                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-xs text-stone-400 block mb-1">Nome no Cartão</label>
                      <input
                        type="text"
                        value={cardData.holder}
                        onChange={e => setCardData({ ...cardData, holder: e.target.value })}
                        className="w-full bg-[#181a22] border border-[#313544] rounded p-2 text-xs text-white"
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="text-xs text-stone-400 block mb-1">Validade</label>
                        <input
                          type="text"
                          value={cardData.expiry}
                          onChange={e => setCardData({ ...cardData, expiry: e.target.value })}
                          className="w-full bg-[#181a22] border border-[#313544] rounded p-2 text-xs text-white font-mono text-center"
                        />
                      </div>
                      <div>
                        <label className="text-xs text-stone-400 block mb-1">CVV</label>
                        <input
                          type="text"
                          value={cardData.cvv}
                  ...
                  <div>
                    <label className="text-xs text-stone-400 block mb-1">Parcelamento InfinitePay</label>
                    <select
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded bg-gradient-to-r from-[#c89b3c] to-[#a87e28] hover:from-[#d9ab4b] hover:to-[#b88c32] text-black font-semibold text-sm transition shadow-lg shadow-[#c89b3c]/20 flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {isProcessing ? (
                  <div className="flex items-center gap-2">
