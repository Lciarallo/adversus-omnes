...
export const CustomerPortal: React.FC = () => {
  ...
  // User purchased materials or accessible materials
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-[#171922] via-[#14161f] to-[#121319] border border-[#272b38] flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-[#20232e] border-2 border-[#c89b3c] flex items-center justify-center text-[#c89b3c] text-xl font-cinzel font-bold shadow-lg">
        ...
        <div className="flex items-center gap-2 bg-[#0e1014] p-2 rounded-lg border border-[#262a37] text-xs">
          <span className="text-stone-400">Alternar modo de teste:</span>
          <button
      ...
      {/* Tabs Menu */}
      <div className="border-b border-[#252834] flex gap-4 text-xs">
        <button
        ...
        >
          <BookOpen size={14} />
          <span>Minha Biblioteca & Acervo Liberado ({accessibleItems.length})</span>
        </button>
      </div>
          ...
          {currentUser.activePlan ? (
            <div className="p-6 rounded-xl bg-[#15171f] border border-[#272b38] space-y-4 max-w-2xl">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs pt-2 border-t border-[#222530]">
                <div>
                  <span className="text-stone-500 block">Data de Expiração / Próxima Renovação</span>
              ...
              <div className="pt-2 flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded bg-[#c89b3c] hover:bg-[#d9ab4b] text-black font-semibold text-xs transition"
                >
                  Ir para Acervo Exclusivo
                </button>
                <button
                  onClick={cancelSubscription}
                  className="text-stone-400 hover:text-red-400 text-xs transition underline"
                >
            ...
            <div className="p-8 rounded-xl bg-[#15171f] border border-[#272b38] text-center space-y-4 max-w-xl mx-auto">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded bg-[#c89b3c] hover:bg-[#d9ab4b] text-black font-semibold text-xs transition shadow-lg shadow-[#c89b3c]/20"
              >
              ...
              >
                ...
                <div className="space-y-2">
                  {order.items.map(i => (
                    <div
                      key={i.id}
                      className="flex items-center gap-3 p-2 rounded bg-[#1b1e27] border border-[#2a2d3b]"
                    >
                      <img
                        src={i.coverImage}
                        alt=""
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs pt-2 border-t border-[#222530]">
                  <div className="p-3 rounded bg-[#101217] border border-[#252834] space-y-1">
                    ...
                    <div className="text-[11px] text-emerald-400 flex items-center gap-1">
                      <Clock size={12} /> Objeto postado na agência central — Em trânsito
                    </div>
                  </div>
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <h4 className="text-xs font-semibold text-white truncate mt-1">{item.title}</h4>
                ...
                <button
                  ...
                  className="w-full py-2 px-3 rounded bg-[#222532] hover:bg-[#2e3344] text-stone-200 hover:text-white border border-[#353a4c] text-xs font-semibold transition flex items-center justify-center gap-1.5"
                >
                  <Eye size={13} className="text-[#c89b3c]" />
